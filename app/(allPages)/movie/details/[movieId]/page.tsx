    ...
    return (
        <main className="min-h-screen bg-gradient-to-b from-black via-red-900 to-black px-8 py-16 sm:block gap-5">
            <div className="h-full flex sm:flex-row flex-col gap-5">
                <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0, transition: { delay: 1}}} className="px-5 sm:px-10 w-full sm:w-[70%] h-[30rem] py-5 pt-[60%] sm:pt-65 bg-center bg-cover rounded-2xl flex flex-col gap-5" style={{ backgroundImage: `url('https://image.tmdb.org/t/p/w780${movie?.backdrop_path}')` }}>
